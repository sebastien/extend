...
Testing.test("R: Extend.slice for strings")
	...
	Testing.same(Extend.slice("hello", 0),    "h")
	Testing.same(Extend.slice("hello", 0, true), "hello")
	...
	Testing.same(Extend.slice("hello", -2),    "l")
	Testing.same(Extend.slice("hello", -2, true), "lo")
