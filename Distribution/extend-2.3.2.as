...
package extend {
	...
	public var Counters={'Instances':0, 'Classes':0}
}
// 8< ---[extend/Class.as]---
package extend {
	import extend
		...
		*/
		public function Class (declaration){
			...
			instance_proto.getSuper = function(c, ... arguments){
				...
				{
					target._extendProxyWithState = extend.createMapFromItems([c.id,c.proxyWithState(target)]);
				}
				else if ( (typeof(target._extendProxyWithState[c.id]) == 'undefined') )
				{
...
// 8< ---[extend/DebugCallback.as]---
package extend {
	import extend
	import flash.external.ExternalInterface
	import flash.utils.getQualifiedSuperclassName
	import flash.utils.getDefinitionByName
	public var DebugCallback=undefined
}
...
package extend {
	...
	import flash.utils.getQualifiedSuperclassName
	import flash.utils.getDefinitionByName
		public function reduce (iterable, callback){
			var res=undefined;
			var i=0;
			extend.iterate(iterable, function(e, ... arguments){
				if ( (i == 0) )
...
package extend {
	...
	import flash.utils.getQualifiedSuperclassName
	import flash.utils.getDefinitionByName
		public function foldl (seed, iterable, callback){
			var first=true;
			var result=seed;
			extend.iterate(iterable, function(e, ... arguments){
