...
var extend=extend||{}
var self=extend
extend.__VERSION__='2.3.2';extend.Counters={'Instances':0,'Classes':0}
...
{return null}}
extend.keys=function(value){var self=extend;if(extend.isList)
...
{result.push(e)}},self)
return result}
extend.reduce=function(iterable,callback){var self=extend;var res=undefined;var i=0;extend.iterate(iterable,function(e){if((i==0))
{res=e;}
else if(true)
{res=callback(res,e);}
i=(i+1);},self)
